...
**Description:** Support for routing over CCTP between EVM chains and Noble in either direction

**Opt-out switch**: CCTP routing will auto-activate on March 13 2024
