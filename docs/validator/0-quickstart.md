...
:::caution Not currently applicable for Evmos v13.0.0-rc1 and beyond
...
The dependency will be made public pending an audit, but in the meantime, you can instead use the prebuilt binaries attached to releases [here](https://github.com/skip-mev/evmos/releases).
:::
...
- **Find the correct values for sentinel_peer_string and sentinel_rpc_string in the table below:**
  ...
  **Testnets**
  ...
  | Neutron Testnet   | pion-1        | v0.4.2                  | https://pion-1-api.skip.money        | `f44aa4467a5c411f650fd9223644d70afc1eacd1@pion-1-sentinel.skip.money:26656`       |
